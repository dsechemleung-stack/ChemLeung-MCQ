          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl border-2 border-slate-200" onClick={(e) => e.stopPropagation()}>
            <div className="p-5 border-b-2 border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-black text-slate-800">Priority Review mechanism</h3>
              </div>
            ...
            <div className="p-5 space-y-3 text-sm text-slate-700">
              <p className="font-medium">
                This panel surfaces the <strong>top 3 most urgent mistakes</strong> using the ISRS priority score.
              </p>
              <div className="space-y-2">
                <div>
                  <div className="font-black text-slate-800">What increases priority</div>
                  <div className="text-slate-600 font-medium">More recent wrong attempts, repeated mistakes, and topics you’ve studied recently.</div>
                </div>
                <div>
                  <div className="font-black text-slate-800">What “Quick Fix” does</div>
                  <div className="text-slate-600 font-medium">Starts a focused practice session for that specific question so you can fix it immediately.</div>
                </div>
              </div>
            </div>
          </div>

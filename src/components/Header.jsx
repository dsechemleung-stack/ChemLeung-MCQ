...
import { Beaker, Home, Trophy, User, LogOut, History, ChevronDown, Menu, X, Languages, BookOpen, MessageSquare, Zap, ShoppingBag, Clock } from 'lucide-react';
                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    {currentUser && (
                        <nav className="hidden md:flex items-center gap-2">
                            ...
                            >
                                <Home size={18} />
                                <span>{isEnglish ? 'Dashboard' : '儀表板'}</span>
                            </button>
                            <button
                    ...
                    {currentUser && (
                        <div className="flex items-center gap-2">
                            ...
                            <div className="relative">
                                ...
                                >
                                    {/* Profile Icon - with equipped item */}
                                    <div className="w-8 h-8 bg-gradient-to-br from-lab-blue to-blue-700 rounded-full flex items-center justify-center shadow-md text-lg">
                                        {displayIcon}
                                    </div>

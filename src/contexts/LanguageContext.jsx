...
const translations = {
  ...
  zh: {
    ...
    store: {
      ...
      firstCorrect: "首次答對：",
      firstCorrectTokens: "2 代幣（每題一次）",
      correctedMistake: "更正錯題（錯題本 / SRS 複習）：",
      correctedMistakeTokens: "+1 代幣（每題，24小時冷卻）",
      quizBonus: "測驗獎勵（10題或以上）：",
      quizBonusTokens: "100% = 20，80%+ = 15，50%+ = 10",
      leaderboardWeekly: "排行榜（每週）：",
      leaderboardWeeklyTokens: "第1名=10，第2名=9，第3名=8，依此類推",
      leaderboardMonthly: "排行榜（每月）：",
      leaderboardMonthlyTokens: "每週獎勵的三倍",
      studyStreaks: "學習連勝：",

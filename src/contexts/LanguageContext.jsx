...
const translations = {
  en: {
    ...
    practiceModeCarousel: {
      ...
      mistakeReviewTitle: "SRS Review",
      mistakeReviewSubtitle: "Master your weaknesses",
      mistakeReviewDesc: "Turn mistakes into strengths with spaced repetition.",
  ...
  zh: {
    ...
    dashboard: {
      ...
      viewAll: "查看全部",
      noLearningData: "尚未有學習數據",
      startLearningJourney: "開始您的學習之旅",
      startPracticing: "開始練習以查看洞察",
      availableFeatures: "可用功能",
      learningFeatures: "學習功能",
      exploreLearningNotebook: "探索學習筆記本",
      openLearningNotebook: "開啟學習筆記本",
      
      // Feature titles and descriptions
      learningAnalytics: "學習分析",
      learningAnalyticsDesc: "追蹤進度與表現模式",
      mistakeDeckWithSRS: "錯題卡組與間隔重複",
      mistakeDeckWithSRSDesc: "最佳學習效果的間隔重複系統",
      masteryArchiveSystem: "精通封存系統",
      masteryArchiveSystemDesc: "已精通主題的有序收藏",
      progressTrackingCharts: "進度追蹤與圖表",
      progressTrackingChartsDesc: "學習旅程的視覺化洞察",
      
      // Stats
      totalMistakes: "總錯題數",
      topics: "主題",
      repeated: "重複",
      topTopicsToFocus: "重點關注主題",
      mistakes: "錯題",
      density: "密度",
      dailyReward: "每日獎勵",
      claiming: "領取中...",
      ...
      aiHowGeneratesDesc: "• 分析各主題／子主題的準確率趨勢\n• 識別弱項（準確率低於 60%）\n• 優先處理近期表現不佳的主題\n• 建議最佳練習題數",

        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                💡 Study plan will focus on this topic
              </p>
            </div>
            ...
            <div>
              ...
              {topic && (
                <p className="text-xs text-slate-500 mt-1">
                  💡 Narrow down to specific subtopic
                </p>
              )}
            </div>
          </div>
          ...
          <div className={`p-4 rounded-xl border-2 ${
            ...
            {topic && (
              <p className="text-xs font-bold mt-2 text-slate-700">
                📚 All sessions will focus on: {topic}
                {subtopic && ` → ${subtopic}`}
              </p>
            )}
          </div>
          ...
          <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
            <p className="text-sm text-blue-900">
              <strong>✨ Smart Study Plan:</strong> Daily study suggestions will be created automatically. 
